...
| visualizationSchemas |  `VisualizationSchema[]` | 该洞察的可视化方案，包含图表类型、标题、洞察描述以及图表配置（基于G2Plot） | `[{ type: 'column_chart', caption: string, insightSummaries: string[], insightSummarySchemas:IPhrase[], string[], chartSchema: G2PlotConfig }]` |
