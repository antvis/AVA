...
export const AdvisorPanel = () => {
  ...
  return (
    <div style={{marginBottom: 20, maxWidth: 1000}}>
      {/* <h1>Advisor</h1> */}
      <Divider orientation="left" plain style={{fontSize: 20}}> Advisor </Divider>
      <Row align="middle" justify="space-around">
        <Col span={8}><Table rowKey={(_, index) => index} size='small' style={{ marginLeft: 10, marginRight: 10}} dataSource={testData} columns={dataCols} pagination={false}></Table></Col>
        <Col span={4}><div style={{textAlign: 'center'}}><Button onClick={getAdvicesFromAdvisor} style={{margin: 'auto'}}>Advise</Button></div></Col>
        <Col span={12}><AdviceCard advices={advices}></AdviceCard></Col>
      </Row>
    </div>
  );
};
