...
const sampleQuery = '用矩阵树图展示一个超市的商品分类及其库存数量，如有三个主分类：食品、饮料和日用品。食品类有 300 件，饮料类有 200 件，日用品类有 500 件。食品类分为新鲜食品 150 件、罐头食品 100 件和零食 50 件；饮料类分为碳酸饮料 100 件和果汁 100 件；日用品类分为清洁用品 300 件和个人护理 200 件：';
