...
const sampleQuery = '创建一个社交网络图，展示 Alice、Bob、Charlie 和 David 之间的朋友关系。节点是这四个人，他们之间的关系是：Alice 是 Bob 和 Charlie 的朋友，Bob 和 Charlie 也是朋友，Charlie 还认识 David。请用网络图表示这些关系。';
