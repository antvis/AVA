...
export const base: ChartKnowledgeBase = {
  ...
  gauge_chart: {
    id: 'gauge_chart',
    name: 'Gauge Chart',
    alias: ['Dial Chart', 'Speedometer Chart'],
    family: ['Others'],
    def:
      'The gauge chart consists of a gauge axis, needles that uses the needle to display the data as a dial reading.',
    purpose: ['Value', 'Comparison'],
    coord: ['Polar'],
    category: ['Statistic'],
    shape: ['Round'],
    dataPres: [
      { minQty: 0, maxQty: 1, fieldConditions: ['Nominal', 'Ordinal'] },
      { minQty: 1, maxQty: 1, fieldConditions: ['Interval'] },
    ],
    channel: ['Angle', 'Color'],
    recRate: 'Recommended',
  ...
  sunburst_diagram: {
    ...
    family: ['TreeGraph'],
    def:
      'A visual representation of a data tree with nodes. Each node is displayed as a ring, angled and colored according to values that you assign.',
    purpose: ['Composition', 'Comparison', 'Hierarchy'],
    coord: ['Polar'],
    category: ['Graph'],
    shape: ['Round'],
