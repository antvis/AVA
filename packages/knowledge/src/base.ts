...
export const base: ChartKnowledgeBase = {
  ...
  fruchterman_layout_cluster_graph: {
    ...
    name: 'Fruchaterman Clustering Graph Layout',
    alias: [],
    family: ['GeneralGraph'],
    def: 'A type of force directed graph layout shows the clustering infomation.',
    purpose: ['Relation', 'Cluster'],
    coord: ['Cartesian2D'],
    category: ['Graph'],
    shape: ['NodeLink'],
    dataPres: [{ minQty: 1, maxQty: '*', fieldConditions: ['Nominal'] }],
  ...
  chart_map: {
    ...
    family: ['Map', 'PointLayer'],
    def: '',
    purpose: ['Composition', 'Distribution', 'Comparison'],
    coord: [],
    category: ['Map'],
    shape: [],
    dataPres: [],
