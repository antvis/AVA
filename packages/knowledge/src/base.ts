...
export const base: ChartKnowledgeBase = {
  ...
  treemap: {
    ...
    alias: [],
    family: ['TreeGraph'],
    def: 'A visual representation of a data tree, where each node can have zero or more children, and one parent (except for the root, which has no parents). Each node is displayed as a rectangle, sized and colored according to values that you assign',
    purpose: ['Composition', 'Comparison'],
    coord: ['Cartesian2D'],
    category: ['Statistic'],
    shape: ['Square'],
    dataPres: [],
