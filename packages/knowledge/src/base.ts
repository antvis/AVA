...
export const base: ChartKnowledgeBase = {
  ...
  choropleth_world_district: {
    id: 'choropleth_world_district',
    name: 'World District',
    alias: [],
    family: ['PolygonLayer'],
    def: 'An World Choropleth Map',
    purpose: ['Distribution', 'Spatial'],
    coord: ['Geo'],
    category: ['Map'],
    shape: ['Fill'],
  ...
  choropleth_china_province_district: {
    id: 'choropleth_china_province_district',
    name: 'China  Province District Map',
    alias: [],
    family: ['PolygonLayer'],
    def: 'An China  Province District Choropleth Map',
    purpose: ['Distribution', 'Spatial'],
    coord: ['Geo'],
    category: ['Map'],
    shape: ['Fill'],
  ...
  choropleth_china_city_district: {
    id: 'choropleth_china_city_district',
    name: 'China City District',
    alias: [],
    family: ['PolygonLayer'],
    def: 'An China CityChoropleth Map',
    purpose: ['Distribution', 'Spatial'],
    coord: ['Geo'],
    category: ['Map'],
    shape: ['Fill'],
  ...
  choropleth_china_county_district: {
    id: 'choropleth_china_county_district',
    name: 'China County District',
    alias: [],
    family: ['PolygonLayer'],
