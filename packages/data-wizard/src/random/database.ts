...
export function getTextDB(): TextDB {
  ...
  const database: TextDB = {
    ...
    clast: {
      ...
      // {@link https://xmcs.buyiju.com/qmyz/20124884.html | 男生名字常用字}
      // prettier-ignore
