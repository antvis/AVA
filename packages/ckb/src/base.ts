...
export const base: ChartKnowledgeBase = {
  ...
  gauge_chart: {
    id: 'gauge_chart',
    name: 'Gauge Chart',
    alias: ['Speedometer', 'Speedometer Chart'],
    family: ['Others'],
    def: 'A gauge chart is used to display a single quantitative value in the context of proportion with a shape that resembles a speedometer.',
    purpose: ['Value', 'Proportion'],
    coord: ['Polar'],
    category: ['Statistic'],
    shape: ['Round'],
    dataPres: [
      { minQty: 1, maxQty: 1, fieldConditions: ['Continuous'] },
      { minQty: 0, maxQty: 1, fieldConditions: ['Ordinal'] },
    ],
    channel: ['Angle', 'Color'],
    recRate: 'Recommended',
  },
  ...
  sunburst_diagram: {
    ...
    purpose: ['Comparison', 'Composition', 'Proportion', 'Hierarchy', 'Relation'],
    coord: ['Polar'],
    category: ['Statistic'],
    shape: ['Round'],
    dataPres: [
