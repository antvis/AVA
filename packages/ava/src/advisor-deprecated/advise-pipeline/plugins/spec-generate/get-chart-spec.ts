...
import type { ChartId, ChartKnowledge } from '@ava/ckb';
import type { BasicDataPropertyForAdvice } from '@advisor-deprecated/ruler';
import type { Advice, ChartEncodeMapping } from '@advisor-deprecated/types';
