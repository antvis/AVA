...
import type { ScoringResultForChartType, Advice, AdviseResult, ChartAdviseParams } from '@advisor-deprecated/types';
import type { RuleModule } from '@advisor-deprecated/ruler/types';
