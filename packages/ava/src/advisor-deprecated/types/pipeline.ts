...
/** Advisor 模块内引用 */
import type { RuleConfig, BasicDataPropertyForAdvice, Preferences, RuleType } from '@advisor-deprecated/ruler/types';
import type { Advisor } from '@advisor-deprecated/advisor';
