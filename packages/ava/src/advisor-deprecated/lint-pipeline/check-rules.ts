...
import type { LintResult, ScoringResultForRule, LintParams, Lint } from '@advisor-deprecated/types';
import type { BasicDataPropertyForAdvice, RuleModule } from '@advisor-deprecated/ruler';
