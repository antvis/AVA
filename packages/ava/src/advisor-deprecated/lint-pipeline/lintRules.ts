...
import type { ScoringResultForRule, Lint, AdvisorPipelineContext } from '@advisor-deprecated/types';
import type { ChartRuleModule, DesignRuleModule } from '@advisor-deprecated/ruler';
