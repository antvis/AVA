...
import { ChartConfig, ChartKnowledgeMap, Data, Meta, PlainDataType } from '../../../types';
...
export const getChartAdvisePrompt = (params: { metas: Meta[]; data: PlainDataType; purpose: string }[]) => {
...
export const getSpecGeneratePrompt = (params: { chartId: string; data: PlainDataType }[]) => {
