...
export function areaChart({ data, dataProps, encode }: GenerateChartSpecParams): Advice['spec'] {
...
export function stackedAreaChart({ data, dataProps, encode }: GenerateChartSpecParams): Advice['spec'] {
