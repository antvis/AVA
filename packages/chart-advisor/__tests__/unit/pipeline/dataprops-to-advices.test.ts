...
describe('API - dataPropsToAdvices', () => {
  ...
  describe('Results', () => {
    test('custom chart knowlegde', () => {
      ...
      const customCKB = { column_chart: CKB['column_chart'], bar_chart: CKB['bar_chart'] };
      const specs = dataPropsToAdvices(dataProps, { chartKnowledge: customCKB });
