 ...
 * @public
 */
export const initChartRules = (chartWiki?: Record<ChartID, ChartKnowledgeJSON>): Rule[] => {
  const Wiki = chartWiki ? chartWiki : CKBJson('en-US', true);
  const allChartTypes = Object.keys(Wiki) as ChartType[];
